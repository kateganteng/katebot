...
"headerType": "DOCUMENT", "documentMessage": {
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, 'XYNDYKATZ вσт 🐾', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
let fot = `Made by @${'6282210190420'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
...
▸ Contoh : #daftar ${user}.13`*/
  ...
  if (msg) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "buttonText": "XYNDYKATZ Bot",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": `🎀 MY OWNER`,
                                         "description": "List Owner XYNDYKATZ Bot",
                                         "rowId": ".owner"
                                    }, {
                                         "title": `📛 ABOUT`,
                                         "description": "Tentang XYNDYKATZ Bot", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `📮 LIST MENU`,
                                         "description": "List Menu XYNDYKATZ Bot",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `🧿 SCRIPT`,
                                         "description": "Source code XYNDYKATZ Bot",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `🌸 GROUP BOT`,
                                         "description": "List Group Officia XYNDYKATZ Bot",
                                         "rowId": ".gcbot"
                       }],
                    "title": "Created By Kate Ar Rawawie"
                  }
                        ], "contextInfo": 
                         { "stanzaId": m.key.id,
          ...
          "sections": [
          
                            {
                                ...
                                "rows": [{
                                         ...
                                         "description": "Status XYNDYKATZ Bot",
                                         ...
                                         "description": "Join Ke Grup Official XYNDYKATZ Bot",
                  ...
                  "rows": [{                               
                                         ...
                                         "title": '27 Tahun',
                                         "description": "XYNDYKATZ Is The Best ❤️",
                                ...
                                "description": "Terima kasih banyak untuk user yang telah berpartisipasi dalam XYNDYKATZ Bot",
